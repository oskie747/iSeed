...
// Function to implement wave drive
void WaveDrive(void)
{
    switch (coilState) {
    case step_one:
...
void HalfStepDrive(void)
{
    ...
    case step_four:
        // coil drive A reverse, B reverse
        COIL_A_DIRECTION = 0;
        COIL_A_DIRECTION_INV = 1;
        COIL_B_DIRECTION = 0;
        COIL_B_DIRECTION_INV = 1;
    ...
    case step_eight:
        // coil drive A forward, B forward
        COIL_A_DIRECTION = 1;
        COIL_A_DIRECTION_INV = 0;
        COIL_B_DIRECTION = 1;
        COIL_B_DIRECTION_INV = 0;
...
void __ISR(_TIMER_3_VECTOR) Timer3IntHandler(void)
{
    ...
    if (timerLoopCount > overflowReps) {
        ...
        case stepping:
            ...
            PORTZ03_TRIS = 1; // steps
            //PORTZ04_TRIS = 1; // direction
            //PORTZ05_TRIS = 1; // enable
