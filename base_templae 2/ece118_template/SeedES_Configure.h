...
#define EVENT_CHECK_HEADER "SeedEventChecker.h"

/****************************************************************************/
// This is the list of event checking functions
#define EVENT_CHECK_LIST SeedSoilCheck, SeedCheckIR1, SeedCheckIR2, SeedStepsRemaining
...
#define TIMER0_RESP_FUNC PostSeedService // Replace TIMER_UNUSED with e.g.,PostTemplateService 
#define TIMER1_RESP_FUNC PostSeedHSM     //extend timer seen in SeedHSM
#define TIMER2_RESP_FUNC PostSeedHSM
#define TIMER3_RESP_FUNC PostSeedHSM     //lower timer seen in SeedHSM
#define TIMER4_RESP_FUNC PostSeedHSM     //seed timer seen in SeedHSM
#define TIMER5_RESP_FUNC PostSeedHSM
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "SeedHSM.h"
// the name of the Init function
#define SERV_1_INIT InitSeedHSM
// the name of the run function
#define SERV_1_RUN RunSeedHSM
